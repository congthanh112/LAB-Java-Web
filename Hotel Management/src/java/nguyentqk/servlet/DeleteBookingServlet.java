...
public class DeleteBookingServlet extends HttpServlet {
     ...
     */
    private final String BOOKING_HISTORY = "showBookingHistory";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int bkIDInt = Integer.parseInt(bookID);
            BookingDAO bkDAO = new BookingDAO();
            if (bkDAO.deleteBooking(bkIDInt, user.getEmail())) {
                request.setAttribute("MSGRSEPONSE", "Successfully delete booking " + bookID);
                url = BOOKING_HISTORY;
            }
